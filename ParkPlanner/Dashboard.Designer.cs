namespace ParkPlanner
{
    partial class Dashboard
    {
        ...
        {
            panel1 = new Panel();
            spacesButton = new RoundedButton();
            ...
            // panel1
            // 
            panel1.Controls.Add(spacesButton);
            ...
            // spacesButton
            // 
            spacesButton.BackColor = Color.FromArgb(39, 36, 56);
            spacesButton.CornerRadius = 10;
            spacesButton.FlatAppearance.BorderSize = 0;
            spacesButton.FlatStyle = FlatStyle.Flat;
            spacesButton.Font = new Font("Arial", 12F, FontStyle.Bold, GraphicsUnit.Point, 0);
            spacesButton.ForeColor = Color.White;
            spacesButton.Location = new Point(0, 190);
            spacesButton.Name = "spacesButton";
            spacesButton.Size = new Size(200, 43);
            spacesButton.TabIndex = 1;
            spacesButton.Text = "Parking Spaces";
            spacesButton.UseVisualStyleBackColor = false;
            // 
            // overviewButton
            // 
        ...
        private RoundedButton spacesButton;
