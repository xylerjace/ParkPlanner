namespace ParkPlanner
{
    partial class LoginPage
    {
        ...
        private void InitializeComponent()
        {
            ...
            label8.Font = new Font("Arial", 48F, FontStyle.Bold, GraphicsUnit.Point, 0);
            label8.ForeColor = Color.White;
            label8.Location = new Point(61, 44);
            label8.Name = "label8";
            label8.Size = new Size(172, 75);
            label8.TabIndex = 6;
            label8.Text = "Park";
            // 
            // label5
